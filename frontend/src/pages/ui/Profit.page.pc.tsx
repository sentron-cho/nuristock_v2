...
export const ProfitPagePc = () => {
  ...
  return (
    <StyledPage className='profit' summaryData={summaryData} onClickSummary={onClickSummary}>
      ...
      <ProfitView active={filter === 'months'} viewType={'months'} profitData={profitData?.value} yearsData={yearsData?.value} />
      <ProfitView active={filter === 'days'} viewType={'days'} profitData={profitData?.value} yearsData={yearsData?.value} />
      <ProfitView active={filter === 'all'} viewType={'all'} profitData={profitData?.value} yearsData={yearsData?.value} />
    </StyledPage>
  );
};