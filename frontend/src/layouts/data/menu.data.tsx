...
import { IconDiary, IconDividend, IconHome, IconInvest, IconSonic, IconStockSearch } from '@entites/Icons';

export const Menus = () => {
	return [
		{ value: URL.ROOT, label: ST.MENU.DASHBOARD, icon: <IconHome fontSize='small' /> },
