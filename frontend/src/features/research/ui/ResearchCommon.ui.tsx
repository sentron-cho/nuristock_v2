...
import { useResearchPerValueHook } from '../hook/Research.hook';
...
export const ResearchInfoField = ({ data }: { data?: ResearchItemType }) => {
...
export const PerValueField = ({ data }: { data?: ResearchItemType }) => {
	const { list } = useResearchPerValueHook(data);
...
export const ResearchChip = ({ data }: { data?: ResearchItemType }) => {
