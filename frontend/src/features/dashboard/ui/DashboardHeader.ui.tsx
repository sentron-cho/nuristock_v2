...
import { IconExpandDown, IconExpandUp, IconMoreHori, IconMoreVert } from '@entites/Icons';
...
export const DashboardHeader = ({
	...
	const { buy, sonic, isMoreBuy, isMoreSonic, isShowConfig, onClickMoreBuy, onClickMoreSonic, onClickShowConfig } =
